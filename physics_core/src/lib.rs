...
// pub use cimvr_engine_interface::prelude::*;
...
#[cfg(feature = "dim3")]
pub mod math {
    use glam::{Quat, Vec3}; // Use glams Quat + Vec3
    /// The real type (f32 or f64).
    pub type Real = rapier::math::Real;
    /// The vector type.
    pub type Vect = Vec3;
...
pub mod prelude {
    /// See (EntityId)[cimvr_engine_interface::prelude::EntityId]
    pub(crate) type Entity = cimvr_engine_interface::prelude::EntityId;
