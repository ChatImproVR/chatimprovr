...
#[derive(Copy, Clone, Debug, Component, Default, Serialize, Deserialize)]
...
#[derive(Copy, Clone, Debug, PartialEq, Component, Deserialize, Serialize)]
...
#[derive(Copy, Clone, Debug, Default, PartialEq, Component, Serialize, Deserialize)]
...
bitflags::bitflags! {
    #[derive(Default, Component, Serialize, Deserialize, Copy, Clone)]
...
#[derive(Copy, Clone, Debug, PartialEq, Component, Serialize, Deserialize)]
...
#[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Component, Serialize, Deserialize)]
pub struct Ccd {
...
#[derive(Copy, Clone, Debug, Default, PartialEq, Component, Deserialize, Serialize)]
...
#[derive(Copy, Clone, Default, Debug, PartialEq, Eq, Component, Serialize, Deserialize)]
