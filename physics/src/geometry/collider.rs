...
// TODO: Figure out how this part here works and if I need it.
...
use rapier3d::dynamics::{CoefficientCombineRule, MassProperties};
use rapier3d::geometry::Shape;
use rapier3d::prelude::{ColliderHandle, InteractionGroups, SharedShape};
...
impl From<ActiveCollisionTypes> for rapier3d::geometry::ActiveCollisionTypes {
    fn from(collision_types: ActiveCollisionTypes) -> rapier3d::geometry::ActiveCollisionTypes {
        rapier3d::geometry::ActiveCollisionTypes::from_bits(collision_types.bits)
...
impl From<CollisionGroups> for InteractionGroups {
    fn from(collision_groups: CollisionGroups) -> InteractionGroups {
        InteractionGroups {
            memberships: rapier3d::geometry::Group::from_bits(collision_groups.memberships.bits())
                .unwrap(),
            filter: rapier3d::geometry::Group::from_bits(collision_groups.filters.bits()).unwrap(),
        }
    }
}
...
impl From<SolverGroups> for InteractionGroups {
    fn from(solver_groups: SolverGroups) -> InteractionGroups {
        InteractionGroups {
            memberships: rapier3d::geometry::Group::from_bits(solver_groups.memberships.bits())
                .unwrap(),
            filter: rapier3d::geometry::Group::from_bits(solver_groups.filters.bits()).unwrap(),
        }
    }
}
...
impl From<ActiveHooks> for rapier3d::pipeline::ActiveHooks {
    fn from(active_hooks: ActiveHooks) -> rapier3d::pipeline::ActiveHooks {
        rapier3d::pipeline::ActiveHooks::from_bits(active_hooks.bits)
            .expect("Internal error: invalid active events conversion.")
    }
}
...
impl From<ActiveEvents> for rapier3d::pipeline::ActiveEvents {
    fn from(active_events: ActiveEvents) -> rapier3d::pipeline::ActiveEvents {
        rapier3d::pipeline::ActiveEvents::from_bits(active_events.bits)
            .expect("Internal error: invalid active events conversion.")
    }
}
