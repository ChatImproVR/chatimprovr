...
pub use rapier3d::geometry::SolverFlags;
pub use rapier3d::parry::query::TOIStatus;
pub use rapier3d::parry::shape::TriMeshFlags;
pub use rapier3d::parry::transformation::{vhacd::VHACDParameters, voxelization::FillMode};

use crate::math::{Real, Vect};
use rapier3d::prelude::FeatureId;
...
impl PointProjection {
    pub(crate) fn from_rapier(
        physics_scale: Real,
        raw: rapier3d::parry::query::PointProjection,
    ) -> Self {
        Self {
...
impl From<rapier3d::parry::query::PointProjection> for PointProjection {
    fn from(projection: rapier3d::parry::query::PointProjection) -> PointProjection {
        PointProjection {
...
impl RayIntersection {
    pub(crate) fn from_rapier(
        inter: rapier3d::parry::query::RayIntersection,
...
impl Toi {
    pub(crate) fn from_rapier(physics_scale: Real, toi: rapier3d::parry::query::TOI) -> Self {
        Self {
            toi: toi.toi,
